...
package com.inzi.androidstudio352;
         ...
         //Create input
            ...
            for(int r=0; r<row; r++){
                for( int c=0; c<col; c++){
                   ...
                   irisMatrix[r][c]= com.inzi.androidstudio352.DataSet.irisData[i++];
                }
            }
            ...
            for(int r=0; r<rowLabel; r++){
                for( int c=0; c<colLabel; c++){
                    twodimLabel[r][c]= com.inzi.androidstudio352.DataSet.labelData[ii++];
                }
            }
